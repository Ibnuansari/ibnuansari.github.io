...
if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        if($ukuran_file <= 1000000) { // 1000000 Bytes = 1 MB
            ...
            echo "<script>alert('Ukuran gambar terlalu besar. Maksimal 1 MB.');window.location='index.html';</script>";
        }
    } else {
        // jika file ekstensi tidak jpg atau png, tampilkan alert ini
        echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='index.html';</script>";
    }
} else {
