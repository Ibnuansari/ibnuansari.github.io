        ...
        <section class="base">
          ...
          <div class="form-group" align="left">
            <select name="perihal" required>
              ...
              <option value="Info Rumah" <?php echo ($data['perihal'] == 'Info Rumah') ? 'selected' : ''; ?>>Info Rumah
              </option>
              <option value="Booking Rumah" <?php echo ($data['perihal'] == 'Booking Rumah') ? 'selected' : ''; ?>>Booking
                Rumah</option>
              <option value="Jadwal Kunjungan" <?php echo ($data['perihal'] == 'Jadwal Kunjungan') ? 'selected' : ''; ?>>
                Jadwal Kunjungan</option>
            </select>
          </div>
          <div>
          ...
          <div class="listing-buttons">
            <a href="index.php" class="btn btn-detail">
              << Kembali</a>
          </div>
        </section>
      </form>
